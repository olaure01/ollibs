...
$(OLLIBSDIR)/fmsetlist.vo : $(OLLIBSDIR)/fmsetlist.v $(OLLIBSDIR)/Bool_more.vo $(OLLIBSDIR)/funtheory.vo $(OLLIBSDIR)/Permutation_more.vo
$(OLLIBSDIR)/fmsetoidlist.vo : $(OLLIBSDIR)/fmsetoidlist.v
$(OLLIBSDIR)/funtheory.vo: $(OLLIBSDIR)/funtheory.v $(OLLIBSDIR)/List_more.vo
$(OLLIBSDIR)/genperm.vo: $(OLLIBSDIR)/genperm.v $(OLLIBSDIR)/Permutation_more.vo $(OLLIBSDIR)/Permutation_solve.vo $(OLLIBSDIR)/CyclicPerm.vo $(OLLIBSDIR)/CPermutation_solve.vo $(OLLIBSDIR)/List_more.vo $(OLLIBSDIR)/funtheory.vo
$(OLLIBSDIR)/infinite.vo: $(OLLIBSDIR)/infinite.v $(OLLIBSDIR)/List_more.vo $(OLLIBSDIR)/List_Type.vo $(OLLIBSDIR)/funtheory.vo $(OLLIBSDIR)/dectype.vo
$(OLLIBSDIR)/List_more.vo: $(OLLIBSDIR)/List_more.v
$(OLLIBSDIR)/Permutation_more.vo: $(OLLIBSDIR)/Permutation_more.v $(OLLIBSDIR)/funtheory.vo $(OLLIBSDIR)/List_more.vo
$(OLLIBSDIR)/Permutation_solve.vo: $(OLLIBSDIR)/Permutation_solve.v $(OLLIBSDIR)/List_more.vo $(OLLIBSDIR)/Permutation_more.vo
$(OLLIBSDIR)/nattree.vo : $(OLLIBSDIR)/nattree.v $(OLLIBSDIR)/funtheory.vo
...
$(OLLIBSDIR)/List_Type_more.vo: $(OLLIBSDIR)/List_Type_more.v $(OLLIBSDIR)/List_Type.vo  $(OLLIBSDIR)/List_more.vo
...
$(OLLIBSDIR)/genperm_Type.vo: $(OLLIBSDIR)/genperm_Type.v $(OLLIBSDIR)/Permutation_Type_more.vo $(OLLIBSDIR)/CyclicPerm_Type.vo $(OLLIBSDIR)/Permutation_Type_solve.vo $(OLLIBSDIR)/CPermutation_Type_solve.vo $(OLLIBSDIR)/funtheory.vo
