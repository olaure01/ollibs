...
Ltac cperm_Type_rot :=
  ...
  eapply CPermutation_Type_trans; [ apply CPermutation_Type_app_rot | ].
...
with cperm_Type_run :=
  ...
  | |- CPermutation_Type (_ ++ _ ) _ => eapply CPermutation_Type_trans; [ apply cperm_Type | ]
  | H:CPermutation_Type ?l1 _ |- CPermutation_Type ?l1 _
       => list_simpl in H;
          eapply CPermutation_Type_trans; [ apply H | ]
